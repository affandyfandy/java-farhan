...
1. [**`EmailService` Interface**](Lecture 07\Assignment 03\task1\ass4\src\main\java\aliramadhan\ass4\service\EmailService.java)
...
3. [**`EmployeeServiceConstructor` Class**](Lecture 07\Assignment 03\task1\ass4\src\main\java\aliramadhan\ass4\service\EmployeeServiceConstructor.java)
...
[**`EmployeeServiceField` Class**](Lecture 07\Assignment 03\task1\ass4\src\main\java\aliramadhan\ass4\service\EmployeeServiceField.java)
...
[**`Lecture7Application` Class**](/Week%2004/Lecture%2007/Assignment%2002/lecture_7/src/main/java/com/example/lecture_7/Lecture7Application.java)
...
[**`EmployeeController` Class**](Lecture 07\Assignment 03\task2\ass4\src\main\java\aliramadhan\ass4\controller\EmployeeController.java)
...
[**`Lecture7Application` Class**](Lecture 07\Assignment 03\task1\ass4\src\main\java\aliramadhan\ass4\Ass4Application.java)
Serves as the main application for the Java Spring Boot.
