...
class EmployeeComp {
    ...
    public String toString() {
        ...
        return "Employee with id = " + id + name;
    }
}
...
public class EmployeeComposite {
    public static void main(String[] args) {
        ...
        Map<EmployeeKey, EmployeeComp> employeeMap = new HashMap<>();

        // Create Employee and EmployeeKey objects
        EmployeeKey key1 = new EmployeeKey("HR", 101);
        EmployeeComp e1 = new EmployeeComp(101, "Alice");

        EmployeeKey key2 = new EmployeeKey("Finance", 102);
        EmployeeComp e2 = new EmployeeComp(102, "Bob");

        EmployeeKey key3 = new EmployeeKey("HR", 103);
        EmployeeComp e3 = new EmployeeComp(103, "Charlie");
        ...
        for (Map.Entry<EmployeeKey, EmployeeComp> entry : employeeMap.entrySet()) {
        ...
        EmployeeComp foundEmployee = employeeMap.get(searchKey);
