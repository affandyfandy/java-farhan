...
class DateUtilsTest {
    ...
    @Test
    void shouldParseDate_withValidDate() {
    ...
    @Test
    void shouldParseDate_withInvalidDate() {
    ...
    @Test
    void shouldFormatDate_withValidDate() {
    ...
    @Test
    void shouldFormatDateToLocalDate_withValidDate() {
        Date date = new Date();
